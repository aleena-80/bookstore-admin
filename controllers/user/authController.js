...
//       maxAge: 7 * 24 * 60 * 60 * 1000
//     });
//     res.status(200).json({ success: true, redirect: '/users/home' });
//   } catch (error) {
//     console.error('Login Error:', error);
//     res.status(500).json({ error: 'Something went wrong. Please try again later.' });
//   }
...
//       to: email,
//       subject: "OTP Code for Oceanbooks",
//       text: `Hello! Your Ocean Books OTP is ${otp}. Use it within 30 seconds to proceed. Happy reading!`,
//     });
//     res.status(200).json({ 
//       success: true, 
//       message: "OTP sent successfully", 
...
//     const { email } = req.query;
//     if (!email || !otpStore[email]) {
//       return res.redirect('/users/otp/send-otp'); // Back to signup if invalid
//     }
//     return res.render('user/otp-verification', { error: null, success: null, email });
//   }
//   const { otp } = req.body;
